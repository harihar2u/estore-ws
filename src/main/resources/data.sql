...
-- Products
insert into product(id ,name, description, product_sub_type_id,  active) values(1, 'Product 1', 'This is test product used for testing purpose ', 1, true);
insert into product(id ,name, description, product_sub_type_id,  active) values(2, 'Product 2', 'This is test product used for testing purpose ', 2, true);
insert into product(id ,name, description, product_sub_type_id,  active) values(3, 'Product 3', 'This is test product used for testing purpose ', 3, true);
insert into product(id ,name, description, product_sub_type_id,  active) values(4, 'Product 4', 'This is test product used for testing purpose ', 4, true);
insert into product(id ,name, description, product_sub_type_id,  active) values(5, 'Product 5', 'This is test product used for testing purpose ', 5, true);
